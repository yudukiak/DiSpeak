...
const packagerOptions = {
  ...
  platform: 'win32',
  arch: 'ia32',
  version: bldPackage.devDependencies.electron.replace(/\^/, ''), // Electronのバージョン
  overwrite: true, // 上書き
  asar: false, // asarパッケージ化
  'app-version': srcPackage['version'],
  'app-copyright': `(C) 2017 ${srcPackage['author']}`,
  // Windowsのみのオプション
  'version-string': {
    CompanyName: 'prfac.com',
    FileDescription: srcPackage['name'],
...
const installerOptions = {
  ...
  authors: srcPackage['author'],
  owners: srcPackage['author'],
  exe: `${srcPackage['name']}.exe`,
  description: srcPackage['name'],
